...
- Authentication provider requiring users to log in on the exam page before accessing the exam.
  This may be useful in situations where RStudio Connect is not available or where users don't have an account on the RStudio Connect installation.
