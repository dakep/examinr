...
- solution text for text/numeric answers
- expression to determine if answer option is correct/incorrect
  * validation of arguments won't be possible anymore
- "visual" authentication provider, i.e., one with a login UI
- feedback
  * select attempt / re-render sections
