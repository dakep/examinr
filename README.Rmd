...
- Download an exam as RStudio project to give learners the option to write the code on their local computer.
- Storing the evaluation environment to allow results from one code box being used in other code boxes.
